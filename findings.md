...
**Queue item 4: Deck candidate exploration (U39), 2026-07-05 (ESCALATED)**. Mined dataset produced 6 candidate decks. Scored through calibrated bracket ring (tau 0.857, n=20 each): candidate_yushin_ito ring +0.100pp vs trolley baseline (ring 90.0% vs 80.0%), stable delta across three independent runs (n=20/40/40, analysis/candidate_decks_ring_gate.md). Submitted ref 54365656 to ladder after error resolution (refs 54362805 ERROR, 54365656 COMPLETE 651.9, drifted to 732.1). Ladder verdict contradicts ring prediction: candidate settled 496.4 rating / 47.1% win rate (41 fresh episodes), underperforming trolley revert 520.5 rating / 46.2% win rate (42 fresh episodes), delta -24.1pp. This is the strongest ring-to-ladder transfer failure to date (ring +0.100, ladder -24.1). L9 recalibration (2026-07-05, triggered by this finding) responds by making the bracket ring the primary decision gate and demoting ladder single-reads as noisy; candidate remains ring-promoted (ring evidence independent of ladder noise) and is eligible for future resubmission with larger validation samples. Floor restoration attempt (ref 54366402/54366910 ERROR, 54367075 COMPLETE 442.8) landed to hold the ring-best ability build. Candidate continues under investigation; no further submission planned until conditions change. KEY FINDING: small-sample ring predictions (n=20/40 initial) do not automatically transfer to broad ladder matchmaking, but this does not refute the ring's authority as a decision gate, only clarifies its scope and limitations. (analysis/candidate_decks_ring_gate.md, state/current.md L9 protocol, docs/writeup/offline_ladder_transfer.md section on ring-to-ladder transfer, Attempt 4 updated 2026-07-05)
